...
export default class FeedbackForm extends Component {
  ...
  _openForm(e) {
    ...
    if (progress === "done") {
      ...
      this.setState({progress: 'closed'})
    } else {
      this.setState({progress: 'open'})
    }
    return
  }
  ...
  render() {
            ...
            <div className="feedback-form-content">
              ...
              <div className="panel-body">
                <form onSubmit={this._handleSubmit.bind(this)}>
                  ...
                  <div className="form-group">
                    <button type="submit" className="submit-btn">Send Message
    ...
    return (
      <li className="feedback-form-container quick-link">
        <div className="menu-icon" onClick={this._openForm.bind(this)}>
          {icon}
        </div>
        {form}
      </li>
