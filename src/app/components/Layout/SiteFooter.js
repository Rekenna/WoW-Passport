      ...
      <div className="site-footer container">
        <div className="row">
          <div className="col-md-12">
            ...
            <p className="center">Love WoWPassport? <a className="mail" href="mailto:ryanpatmckenna@gmail.com">Tell me what you love</a> or <a className="patreon" href="https://www.patreon.com/rekenna">Support Development</a></p>
