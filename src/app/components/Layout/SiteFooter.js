          ...
          <div className="container">
            <div className="row">
              <div className="col-md-6">
                <p className="text-left">Made with <i className="fa fa-heart"></i> by <a href="mailto:ryanpatmckenna@gmail.com" rel="noopener noreferrer" target="_blank">Ryan P McKenna</a>.</p>
              </div>
              <div className="col-md-6">
                <div className="actions">
                  <a className="mail" href="mailto:ryanpatmckenna@gmail.com">
                    <i className="fa fa-envelope"></i>Send Feedback</a>
